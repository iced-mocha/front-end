...
class SettingsPage extends React.Component {
  ...
  getUserWeights(user) {
	...
	submitChanges() {
    console.log("submnitting changes with updated user " + JSON.stringify(this.state.updatedUser));
    ...
    if (this.rssFeedsChanged()) {
      console.log("Rss feeds changed");
      console.log("updating groups " + JSON.stringify(this.state.updatedUser['rss-groups']));
      axios({
        method: 'post',
